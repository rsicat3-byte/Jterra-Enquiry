...
Add the script. In the Sheet open Extensions > Apps Script, delete the sample code, paste in the contents of `Code.gs`, and save. Optional: set `NOTIFY\_EMAIL` to get an email for each enquiry.
